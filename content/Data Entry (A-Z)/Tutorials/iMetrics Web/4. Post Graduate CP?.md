...
As mentioned in the flowchart above Reporting Team (Field Admins, Reporting Admins) are to receive the Post-Graduate Church Plant reports from the Point-Persons (or Team Leaders). They might still use the Paul Report Forms for the the submission of Post-Graduate Church Plants and its ok as its the same parameters. The main thing is that Field Admins, Reporting Admins are to be in constant touch with the Team Leaders for the reports (updates) and save all the reports in the excel file (especially made for PG church plant) [[[[SC_PMTmonReport_2026.xlsx]]

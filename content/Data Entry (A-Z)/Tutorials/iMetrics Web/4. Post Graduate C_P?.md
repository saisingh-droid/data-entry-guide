...
%% Custom Styling & Colors provided by you
...
classDef guidelines fill:#fafafa,stroke:#333,stroke-width:2px,stroke-dasharray: 5 5,color:#333,text-align:left;
...
E["ZLs are to verify before<br/>reporting"]:::zl

F["Corrections/Updates:<br/>1. Church plant dropped<br/>2. Timothy dropped<br/>3. New Believers update"]:::side

G["ZLs update the<br/>progress to PP and<br/>Team Leader<br/>(monthly)"]:::zl

H["PP, Team Leader<br/>submit the reports to<br/>Reporting team"]:::reporting

I["Reporting team<br/>updates the reports to<br/>iMetrics & informs PP,<br/>Team Leader"]:::reporting

J["FR plan and visit the<br/>church plants"]:::fr
...
%% Red Clarification Feedback Loops

H -- "<span style='color:#cc0000; font-weight:bold'>clarification</span>" --> G

I -- "<span style='color:#cc0000; font-weight:bold'>clarification</span>" --> H


%% Invisible link to nicely position the guidelines box at the bottom

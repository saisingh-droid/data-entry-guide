...
# **⚙️ 3. How the Tool Works (Conceptual Flow)**
...
```
![Country Selection Map](images/Sparrowv2.CountryMap.png)
```
...
```
![Boundary View](images/Sparrowv2.Adm3Villages.png)
```
...
```
![Add Village](images/Sparrowv2.AddVillage.png)
```
...
```
![Save Edits](images/Sparrowv2.SaveEdits.png)
```
...
```
![Exit Edit Mode](images/Sparrowv2.ExitEditMode.png)
```
...
```
![Change History](images/Sparrowv2.ChangeHistory.png)
```

```
![Change Set](images/Sparrowv2.Changeset.png)
```
...
```
![Submit for Approval](images/Sparrowv2.SubmitForApproval.png)
```
...
```
![Pending Approval](images/Sparrowv2.PendingApproval.png)
```
